  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Courier - Your trusted partner in parcel service. Ensuring swift, secure and reliable delivery for all your needs."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1566576721346-d4a3b4eaeb55?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxwYXJjZWx8ZW58MHx8fHwxNjk4NjU3ODUzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@rosebox?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`RoseBox رز باکس`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Courier - Your trusted partner in parcel service. Ensuring swift, secure and reliable delivery for all your needs.`}
            </Text>
            <Box
